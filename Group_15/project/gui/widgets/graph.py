...
class GraphWidget(QWidget):
    ...
    def initUI(self): 
        ...
        if GraphType.Altitude == self.graph_type:
            ...
            color = THEME['content']
            ax.set_ylabel('Longitude (deg)', color='white')
            ax.set_xlabel('Time (s)', color='white')
        elif GraphType.Velocity == self.graph_type:
            color = THEME['content']
            ax.set_ylabel('Velocity (m/s)', color='white')
            ax.set_xlabel('Time (s)', color='white')
        elif GraphType.Distance == self.graph_type:
            color = THEME['content']
            ax.set_ylabel('Distance (m)', color='white')
            ax.set_xlabel('Time (s)', color='white')
        elif GraphType.Gravity == self.graph_type:
            color = THEME['content']
            ax.set_ylabel('Gravity (m/s²)', color='white')
            ax.set_xlabel('Latitude (deg)', color='white')
        else:
            color = THEME['content']
